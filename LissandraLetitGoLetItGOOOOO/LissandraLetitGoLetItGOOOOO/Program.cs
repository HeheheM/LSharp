...
namespace LissandraLetitGoLetItGOOOOO
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu.SubMenu("Keys").AddItem(new MenuItem("ComboActive", "Combo!").SetValue(new KeyBind("32".ToCharArray()[0], KeyBindType.Press)));
            ...
            menu.SubMenu("Keys").AddItem(new MenuItem("stunMelles", "Stun Enemy Melle Range").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Toggle)));
            menu.SubMenu("Keys").AddItem(new MenuItem("stunTowers", "Stun Enemy under Tower").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Toggle)));
            menu.SubMenu("Keys").AddItem(new MenuItem("LastHitQQ", "Last hit with Q").SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Press)));
            menu.SubMenu("Keys").AddItem(new MenuItem("LaneClearActive", "Farm!").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
